...
public class StudentController {
	...
	public String home(@SessionAttribute(name = "login", required = false) StudentPOJO login, ModelMap map) {
		if (login == null) {
			map.addAttribute("msg", "Login first to proceed  the oparation ..!!");
			return "LoginForm";
		}
		return "Home";
	}
	...
	public String add(@SessionAttribute(name = "login", required = false) StudentPOJO login, ModelMap map) {
		if (login == null) {
			map.addAttribute("msg", "Login first to proceed the Operation !!");
			return "LoginForm";
		}
		return "AddStudent";
	}
	...
	public String addData(@SessionAttribute(name = "login", required = false) StudentPOJO login,
		...
		if (login == null) {
			map.addAttribute("msg", "Login first to proceed  the opearation.!!");
			return "LoginForm";
		}
